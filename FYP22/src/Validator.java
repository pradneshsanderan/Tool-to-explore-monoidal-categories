public class Validator {
     ...
     */
    public static boolean bifunctoriality(Table tensorTable, Table t){
        for(int i = 0; i< Main.morphisms.size(); i++){
            for(int j = 0; j< Main.morphisms.size(); j++){
        ...
        for(int i = 0; i< Main.morphisms.size(); i++){
            for(int j = 0; j< Main.morphisms.size(); j++){
                ...
                if(!lefttSide.name.equals(rightSide.name)){
                    System.out.println("===== COMPONENTS THAT CAUSED AN ERROR ====");
                    System.out.println(lefttSide.name);
                    System.out.println(rightSide.name);
                    return false;
                }
            }
        }
